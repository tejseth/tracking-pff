...
```{r plot-1, echo=FALSE, fig.align = "center", out.height= "50%"}
play_speed_all %>%
...
```{r plot-2, echo=FALSE, fig.align = "center", out.height= "50%"}
play_speed_all %>%
  ggplot(aes(x = avg_speed, y = ybc)) +
...
```{r plot 3, echo = FALSE, fig.align = "center", out.height= "50%"}
...
```{r plot 4, echo = FALSE, fig.align = "center", out.height= "50%"}
...
```{r plot 5, echo = FALSE, fig.align = "center", out.height= "50%"}
rushing_data_speed %>%
...
```{r plot 6, echo = FALSE, fig.align = "center", out.height= "50%"}
...
```{r plot 7, echo = FALSE, fig.align = "center", out.height= "50%"}
...
```{r plot 8, echo = FALSE, fig.align = "center", out.height= "50%"}
